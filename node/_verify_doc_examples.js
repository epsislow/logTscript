 ...
 *
 * Usage:
 *   node node/_verify_doc_examples.js inline-logic
 *   node node/_verify_doc_examples.js comp-logic logic-query-exec
 *   node node/_verify_doc_examples.js --all
 *   node node/_verify_doc_examples.js --list
 *   node node/_verify_doc_examples.js doc/comp-logic.md
 *   node node/_verify_doc_examples.js --blocks-only servo
 *   node node/_verify_doc_examples.js --include-blocks comp-logic
 *   node node/_verify_doc_examples.js '*logic*'
 *   node node/_verify_doc_examples.js -f '*logic*'
 *
...
Examples:
  node node/_verify_doc_examples.js inline-logic
  node node/_verify_doc_examples.js comp-logic logic-runtime
  node node/_verify_doc_examples.js '*logic*'
  node node/_verify_doc_examples.js -f --include-blocks '*logic*'
  node node/_verify_doc_examples.js --all
`);
}
