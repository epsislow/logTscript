...
Interpreter.BUILTIN_DOC = {
  ...
  ADD:      [
    ...
    'ADD(32bit a, 32bit b; f32) -> 32bit result, 4bit status',
    'ADD(64bit a, 64bit b; f64) -> 64bit result, 4bit status',
  ...
  SUBTRACT: [
    ...
    'SUBTRACT(32bit a, 32bit b; f32) -> 32bit result, 4bit status',
    'SUBTRACT(64bit a, 64bit b; f64) -> 64bit result, 4bit status',
  ...
  MULTIPLY: [
    ...
    'MULTIPLY(32bit a, 32bit b; f32) -> 32bit result, 32bit over, 4bit status',
    'MULTIPLY(64bit a, 64bit b; f64) -> 64bit result, 64bit over, 4bit status',
  ...
  DIVIDE:   [
    ...
    'DIVIDE(32bit a, 32bit b; f32) -> 32bit result, 32bit mod, 4bit status',
    'DIVIDE(64bit a, 64bit b; f64) -> 64bit result, 64bit mod, 4bit status',
  ...
  MAC:      [
    ...
    'MAC(32bit acc, 32bit a, 32bit b; f32) -> 32bit result, 33bit over, 4bit status',
    'MAC(64bit acc, 64bit a, 64bit b; f64) -> 64bit result, 65bit over, 4bit status',
  ...
  SUM:      [
    ...
    'SUM(Wbit ...; f32) -> Wbit result, Wbit over, 4bit status',
    'SUM(Wbit ...; f64) -> Wbit result, Wbit over, 4bit status',
  ...
  DOT:      [
    ...
    'DOT(32wire[n] a, 32wire[n] b; f32) -> 32bit result, 64bit over, 4bit status',
    'DOT(64wire[n] a, 64wire[n] b; f64) -> 64bit result, 128bit over, 4bit status',
  ...
  GT:       [
    ...
    'GT(32bit a, 32bit b; f32) -> 1bit',
    'GT(64bit a, 64bit b; f64) -> 1bit',
  ...
  LT:       [
    ...
    'LT(32bit a, 32bit b; f32) -> 1bit',
    'LT(64bit a, 64bit b; f64) -> 1bit',
  ...
  CLAMP:    [
    ...
    'CLAMP(32bit x, 32bit min, 32bit max; f32) -> 32bit',
    'CLAMP(64bit x, 64bit min, 64bit max; f64) -> 64bit',
  ...
  ABS:      [
    ...
    'ABS(32bit x; f32) -> 32bit result, 4bit status',
    'ABS(64bit x; f64) -> 64bit result, 4bit status',
  ],
  NFORMAT:  [
    ...
    'NFORMAT(Xbit a; signed to_f32) -> 32bit result, 4bit status',
    'NFORMAT(Xbit a; signed to_f64) -> 64bit result, 4bit status',
    ...
    'NFORMAT(8bit a; q4p4 to_f32) -> 32bit result, 4bit status',
    ...
    'NFORMAT(32bit a; f32 to_signed) -> 32bit result, 4bit status',
    'NFORMAT(32bit a; f32 to_fp16) -> 16bit result, 4bit status',
    'NFORMAT(32bit a; f32 to_q4p4) -> 8bit result, 4bit status',
    'NFORMAT(64bit a; f64 to_f32) -> 32bit result, 4bit status',
    'NFORMAT(64bit a; f64 to_signed) -> 64bit result, 4bit status',
    'NFORMAT(16bit a; fp16 to_f32) -> 32bit result, 4bit status',
