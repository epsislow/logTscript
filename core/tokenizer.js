...
pushSource({ src, alias }) {
  ...
  tokenizeIdentifier(v) {
    ...
    if (['def', 'show', 'peek', 'probe', 'deps', 'lutOf', 'exprOfLut', 'useLutAs', 'useExpr', 'truthTableOf', 'simplify', 'equivalent', 'inputsOf', 'costOf', 'NEXT', 'TEST', 'MODE', 'STRICT', 'WIREWRITE', 'ZSTATE', 'ZRELEASE', 'Zlist', 'comp', 'pcb', 'chip', 'board', 'inline', 'phz', 'doc', 'watch', 'Allow', 'NotAllow'].includes(v)) {
