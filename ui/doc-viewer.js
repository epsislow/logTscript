...
const DOC_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { file: 'inline-parser-complex-rules.md', label: 'Inline parser — complex rules (lookahead & counts)', searchPrimary: 'parser lookahead ampersand negation rule-level probe count quantifier brace', searchExtra: 'logts-play Load and Run assignLang callSuffix CallFunction packAst parseText' },
