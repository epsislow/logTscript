...
const DOC_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { file: 'inline-parser-complex-rules.md', label: 'Inline parser — complex rules (lookahead, counts & commit)', searchPrimary: 'parser lookahead ampersand negation commit double-dollar skip rule-level probe count quantifier brace', searchExtra: 'logts-play Load and Run assignLang callSuffix CallFunction packAst parseText whileHead CallWhile' },
