...
const DOC_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { file: 'inline-parser.md', label: 'Inline parser (`inline [parser]`)', searchPrimary: 'parser inline.parser token rule grammar capture precedence', searchExtra: 'logts-play Load Load and Run stratified expression alternative backtrack' },
