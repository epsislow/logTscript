...
const DOC_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { file: 'inline-interp.md', label: 'Inline interpreter (`inline [interp]`)', searchPrimary: 'interp inline.interp eval packAst CallAdd type decode env CallAssign', searchExtra: 'logts-play Load and Run astWire schema precedence program' },
