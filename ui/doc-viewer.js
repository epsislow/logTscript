...
const DOC_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { file: 'interp-node-field-access.md', label: 'Inline interpreter — node field access & decode', searchPrimary: 'interp field access node colon decode fieldRef isNode nodeName fieldCount show slice', searchExtra: 'logts-play Load and Run node:left node:0 ref/u8 ascii typeOf field bound leaf' },
  ...
  },
  {
    ...
    items: [
      ...
      { file: 'interp-builtins.md', label: 'Inline interpreter — map & session builtins' },
      { file: 'interp-maps.md', label: 'Inline interpreter — maps (KV tables)' },
